...
>
> ![Screenshot showing the Azure DeVOps Extension for a Linux Machine as well as a Windows Machine](/img/blog/azuredevops-selfhosted-agents-on-azure/azdo-vmextension-both.jpg)
...
![Screenshot showing the Agent Pools available for a project in Azure DevOps. It highlights the Agent Pools item under the Pipelines subsection, as well as the Add Pool button to create a new agent pool.](/img/blog/azuredevops-selfhosted-agents-on-azure/azdo-agentpools.jpg)

From here, you can select the **Add pool** option.

![Screenshot showing the Add agent pool flyout. This contains an option to select a self-hosted pool or an Azure virtual machine scale set](/img/blog/azuredevops-selfhosted-agents-on-azure/azdo-add-agentpool.jpg)
...
![Screenshot showing the Add agent pool flyout, including the configuration options shown above](/img/blog/azuredevops-selfhosted-agents-on-azure/azdo-add-agentpool-2.jpg)
