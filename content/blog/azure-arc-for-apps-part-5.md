...
![Screenshot showing the App Service Kubernetes environment resource in the Azure Portal](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-resource.jpg)
...
![Screenshot showing the Gateway Endpoint and Token information in the Azure Portal](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-gw-self-hosted-deployment.jpg)
...
![Screenshot showing the API Management Gateway Extension installing to the Azure Arc enabled Kubernetes Cluster](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-gw-extension-installing.jpg)
...
![Screenshot showing the API Management Gateway Extension creation process through the Azure Portal](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-gw-extension-portal.jpg)

There is a separate page to configure the Log Analytics workspace. This is optional.

![Screenshot showing the API Management Gateway Extension creation process through the Azure Portal](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-gw-extension-portal-2.jpg)
...
![Screenshot showing the API now associated with the self-hosted gateway](/img/blog/azure-arc-for-apps-part-5/arc-apim-create-apim-gw-self-hosted-apis.jpg)
...
![Screenshot showing the metrics available in the API Management Service Azure Portal blade for the self-hosted gateway](/img/blog/azure-arc-for-apps-part-5/arc-apim-gw-self-hosted-summary.jpg)
...
![Screenshot showing the Gateways listed within an Azure API Management Service Instance](/img/blog/azure-arc-for-apps-part-5/arc-apim-gateways.jpg)
